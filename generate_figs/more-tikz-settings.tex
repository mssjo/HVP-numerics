...
\tikzset{
    ...
    dash4/.style={dash pattern=on 5.6pt off 1.2pt on 1.2pt off 1.2pt on 1.2pt off 1.2pt on 1.2pt off 1.2pt on 1.2pt off 1.2pt},
...
\pgfplotsset{
    plain legend/.style={legend image code/.code={
        \draw [#1] (0pt,+.2ex) -- (\legendwidth,+.2ex);
        }},
    point legend/.style={legend image code/.code={
        \foreach \x in {2.5pt,11pt,19.5pt} \draw[#1] (\x-2.5pt,.2ex) -- (\x+2.5pt,.2ex) (\x,.2ex-2.5pt) -- (\x,.2ex+2.5pt);
        }},
...
%             \addplot[series] table[x=t, y=Re, col sep=tab, restrict y to domain=\Eplotymin:\Eplotymax] {\Eplotfile 0.dat};
            \addplot[real, series dash] table[x=t, y=Re, col sep=tab, restrict y to domain=\Eplotymin:\Eplotymax] {\Eplotfile 05.dat};
...
%             \addplot[series] table[x=t, y=AbsRe, col sep=tab] {\Eplotfile 0.dat};
            \addplot[real, series dash] table[x=t, y=AbsRe, col sep=tab] {\Eplotfile 05.dat};
            \addplot[real, series dash] table[x=t, y=AbsRe, col sep=tab] {\Eplotfile 032.dat};
