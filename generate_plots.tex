        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \begin{scope}
                    ...
                    \addplot[very thin, gray, mark=none] table [x={Retau},y={Imtau}] {plot_data/image_Imt1.0.dat} -- cycle;
                    \addplot[very thin, gray, mark=none] table [x={Retau},y={Imtau}] {plot_data/image_Imt0.5.dat} -- cycle;
                    \addplot[very thin, gray, mark=none] table [x={Retau},y={Imtau}] {plot_data/image_Imt0.1.dat} -- cycle;
                    \addplot[very thin, gray, mark=none] table [x={Retau},y={Imtau}] {plot_data/image_Imt0.001.dat} -- cycle;
                \end{scope}

%                 % Bridge contours
%                 \addplot[densely dashed, twopi, mark=none] table [x={Re(tau)},y={Im(tau)}] {plot_data/t0.50000_sbridge.dat};
%                 \addplot[densely dashed, twopi, mark=none] table [x={Re(tau)},y={Im(tau)}] {plot_data/t0.50000_tbridge.dat};
%                 \addplot[densely dashed, fourpi, mark=none] table [x={Re(tau)},y={Im(tau)}] {plot_data/t0.90000_sbridge.dat};
%                 \addplot[densely dashed, fourpi, mark=none] table [x={Re(tau)},y={Im(tau)}] {plot_data/t0.90000_tbridge.dat};
    ...
    \begin{subfigure}[t]{.4\columnwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[very thin, gray, mark=none] table [x={Req},y={Imq}] {plot_data/image_Imt1.0.dat} -- cycle;
                \addplot[very thin, gray, mark=none] table [x={Req},y={Imq}] {plot_data/image_Imt0.5.dat} -- cycle;
                \addplot[very thin, gray, mark=none] table [x={Req},y={Imq}] {plot_data/image_Imt0.1.dat} -- cycle;
                \addplot[very thin, gray, mark=none] table [x={Req},y={Imq}] {plot_data/image_Imt0.001.dat} -- cycle;

%                 \addplot[densely dashed, twopi, mark=none] table [x={Re(q)},y={Im(q)}] {plot_data/t0.50000_sbridge.dat};
%                 \addplot[densely dashed, twopi, mark=none] table [x={Re(q)},y={Im(q)}] {plot_data/t0.50000_tbridge.dat};
%                 \addplot[densely dashed, fourpi, mark=none] table [x={Re(q)},y={Im(q)}] {plot_data/t0.90000_sbridge.dat};
%                 \addplot[densely dashed, fourpi, mark=none] table [x={Re(q)},y={Im(q)}] {plot_data/t0.90000_tbridge.dat};
...
%                 Contours at fixed epsilon
                \addplot[tcontour=-5:5] table [x={Rezc},y={Imzc}] {plot_data/image_Imt1.0.dat} -- (9,0);
                \addplot[tcontour=-5:5] table [x={Rezc},y={Imzc}] {plot_data/image_Imt0.5.dat} -- (9,0);
                \addplot[tcontour=-5:5] table [x={Rezc},y={Imzc}] {plot_data/image_Imt0.1.dat} -- (9,0);
                \addplot[tcontour=-5:5] table [x={Rezc},y={Imzc}] {plot_data/image_Imt0.001.dat} -- (9,0);

                \addplot[tcontour=-5:5, densely dashed] table [x={Rezr},y={Imzr}] {plot_data/image_Imt1.0.dat};
                \addplot[tcontour=-5:5, densely dashed] table [x={Rezr},y={Imzr}] {plot_data/image_Imt0.5.dat};
                \addplot[tcontour=-5:5, densely dashed] table [x={Rezr},y={Imzr}] {plot_data/image_Imt0.1.dat};
                \addplot[tcontour=-5:5, densely dashed] table [x={Rezr},y={Imzr}] {plot_data/image_Imt0.001.dat};
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \begin{scope}
                ...
                \addplot[mark=none, realneg] table {plot_data/im0.dat};
            \end{scope}
            \begin{scope}
                \clip (root1u) -| (3,+3) -- (-3,+3) |- cycle;
                \addplot[mark=none, realpos, nocut] table {plot_data/im0.dat};
            \end{scope}
            \begin{scope}
            ...
            \begin{scope}
                ...
                \addplot[mark=none, black] table {plot_data/im0.dat};
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot graphics [
                xmin=-3, xmax=12,
                ymin=-3, ymax=0,
            ]   {plots/hyper_before.png};
            \addplot graphics [
                xmin=-3, xmax=12,
                ymin=0, ymax=3,
            ] {plots/hyper_after.png};

            % Insets
            \addplot graphics [
                xmin=\insetXmin, xmax=\insetXmax,
                ymin=+\insetYmin, ymax=+\insetYmax,
            ] {plots/hyper_after_inset.png};
            \addplot graphics [
                xmin=\insetXmin, xmax=\insetXmax,
                ymin=-\insetYmin, ymax=-\insetYmax,
            ] {plots/hyper_before_inset.png};
...
%                 xmin=-3, xmax=12,
%                 ymin=-3, ymax=3,
%             ] {plots/abs_jsun_geq1.png};
            % Never mind -- join_contours.py brought it within those capabilities!
            \addplot[mark=none, draw=none, fill=realextra!40, even odd rule] table {plot_data/re12.dat} -- cycle;
%             % Visualizing the effects of join_contours.py
%             \addplot[red, mark=o, draw=none] table {plot_data/re12.dat.log};
            ...
            %  (the locus of all zeroes is in plot_data/im0N.dat).
...
%                 \addplot[mark=none, plotII] table {plot_data/im01.dat} ;
%                 \addplot[mark=none, plotI] table {plot_data/im02.dat};
%                 \addplot[mark=none, plotIV] table {plot_data/im03.dat};

            % Piecewise curves usling clipped scopes
            \begin{scope}
                \clip (zim032) |- (12,.25) -- (12,3) -| (zim012) |- (12,-3) -- (12,-.25) -| cycle;
                \addplot[mark=none, realneg, nocut] table {plot_data/im01.dat};
                \addplot[mark=none, realpos, nocut] table {plot_data/im02.dat};
                \addplot[mark=none, realneg, nocut] table {plot_data/im03.dat};
            \end{scope}
            \begin{scope}
                \clip (zim032) |- (12,.25) -- (12,-.25) -| cycle;
                \addplot[mark=none, realpos] table {plot_data/im03.dat};
            \end{scope}
            \begin{scope}
                \clip (xing1u) -- (-3,2) -- (-3,-2) -- (xing1l) -- cycle;
                \addplot[mark=none, realneg] table {plot_data/im01.dat};
%                     \addplot[mark=none, realpos, branchcut] table {plot_data/im02.dat};
            ...
            \begin{scope}
                ...
                \addplot[mark=none, realneg] table {plot_data/im02.dat};
                \addplot[mark=none, realpos] table {plot_data/im03.dat};
            \end{scope}
            \begin{scope}
                \clip (xing1u) -- (1,+1) -| (zim022) |- (1,-1)  -- (xing1l) -- (-3,-3) -| (zim012) |- (-3,+3) -- cycle;
                \addplot[mark=none, realpos] table {plot_data/im01.dat};
                \addplot[mark=none, realpos, nocut] table {plot_data/im02.dat};
                \addplot[mark=none, realneg, nocut] table {plot_data/im03.dat};
            \end{scope}
...
\begin{figure}
    ...
    \def\hybridfile{plot_data/hybrid_err_t-2.0}
...
\begin{figure}
    \def\Eplotfile{plot_data/PiE.dat}
    \hspace{-1cm}
...
\begin{figure}
    \def\Jplotfile{plot_data/PiJ.dat}
    \def\Zplotfile{plot_data/PiZ.dat}
    \hspace{-1cm}
